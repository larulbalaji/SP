...
/* jshint maxparams:10 */
function IIQStatsCtrl(SearchData, PageState, PagingData, $q, $timeout, configService, IIQStatsService, navigationService, ListResultDTO, ListResultCache) {
    //'ngInject';
    //console.log("Ctrl");
    var me = this, 
    ...
    //
    ////////////////////////////////////////////////////////////////////////
    IIQStatsCtrl._super.call(this, SearchData, $q, $timeout, configService, new PageState(new PagingData(5)));
    ////////////////////////////////////////////////////////////////////////
    //
    ...
    function loadIntoCache(searchTerm, startIdx) {
        ...
        return IIQStatsService.getStats(searchTerm, startIdx, CACHE_CHUNK_SIZE).then(function (users) {
    ...
    this.nextPage = function () {
        ...
        // Do the paging.
        changePage(IIQStatsCtrl._super.prototype.nextPage.bind(me));
    };
    /**
    ...
    this.previousPage = function () {
        ...
        changePage(IIQStatsCtrl._super.prototype.previousPage.bind(me))["finally"](function () {
     ...
     */
    this.viewEndpoint = function(iiqstat) {
...
IIQStatsCtrl.$inject = ['SearchData', 'PageState', 'PagingData', '$q', '$timeout', 'configService', 'IIQStatsService', 'navigationService', 'ListResultDTO', 'ListResultCache'];

SailPoint.extend(IIQStatsCtrl, AbstractListCtrl);
angular.module('sailpoint.home.widget').controller('IIQStatsCtrl', IIQStatsCtrl);
})();
