...
/* jshint maxparams:10 */
function SensitiveDataUserWidgetDirectiveCtrl(SearchData, PageState, PagingData, $q, $timeout, configService, sensitiveDataUserService, navigationService, ListResultDTO, ListResultCache) {
    //'ngInject';
    ...
    //
    ////////////////////////////////////////////////////////////////////////
    SensitiveDataUserWidgetDirectiveCtrl._super.call(this, SearchData, $q, $timeout, configService, new PageState(new PagingData(5)));
    ////////////////////////////////////////////////////////////////////////
    //
    ...
    function loadIntoCache(searchTerm, startIdx) {
        ...
        return sensitiveDataUserService.getSensitiveDataUsers(searchTerm, startIdx, CACHE_CHUNK_SIZE).then(function (users) {
    ...
    this.previousPage = function () {
        ...
        changePage(SensitiveDataUserWidgetDirectiveCtrl._super.prototype.previousPage.bind(me))["finally"](function () {
    ...
    this.viewIdentity = function (sensUser) {
    	...
    	//console.log(sensUser);
    	//console.log(sensUser.id);
...
SensitiveDataUserWidgetDirectiveCtrl.$inject = ['SearchData', 'PageState', 'PagingData', '$q', '$timeout', 'configService', 'sensitiveDataUserService', 'navigationService', 'ListResultDTO', 'ListResultCache'];

SailPoint.extend(SensitiveDataUserWidgetDirectiveCtrl, AbstractListCtrl);
angular.module('sailpoint.home.widget').controller('SensitiveDataUserWidgetDirectiveCtrl', SensitiveDataUserWidgetDirectiveCtrl);
})();
