...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var AbstractListCtrl_1 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"AbstractListCtrl\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	//var AbstractListCtrl_1 = AbstractListCtrl;
	/**
	 * Controller that shows the direct reports for a manager.
	 */
	/* jshint maxparams:10 */
	function MostEntitlementsUserWidgetDirectiveCtrl(SearchData, PageState, PagingData, $q, $timeout, configService, mostEntitlementsUserService, navigationService, ListResultDTO, ListResultCache) {
	    'ngInject';
	    var me = this, 
	    ...
	    //
	    ////////////////////////////////////////////////////////////////////////
	    MostEntitlementsUserWidgetDirectiveCtrl._super.call(this, SearchData, $q, $timeout, configService, new PageState(new PagingData(5)));
	    ////////////////////////////////////////////////////////////////////////
	    //
	    ...
	    function loadIntoCache(searchTerm, startIdx) {
	        return mostEntitlementsUserService.getDirectReports(searchTerm, startIdx, CACHE_CHUNK_SIZE).then(function (users) {
	    ...
	    this.nextPage = function () {
	        ...
	        // Do the paging.
	        changePage(MostEntitlementsUserWidgetDirectiveCtrl._super.prototype.nextPage.bind(me));
	    };
	    /**
	    ...
	    this.previousPage = function () {
	        ...
	        changePage(MostEntitlementsUserWidgetDirectiveCtrl._super.prototype.previousPage.bind(me))["finally"](function () {
	     ...
	     */
	    this.viewIdentity = function (directReport) {
	        navigationService.go({
	            outcome: 'viewIdentity#/identities/' + directReport.id + '/attributes'
	        });
	    };
	    /**
	     ...
	     * @param {DirectReport} directReport The direct report.
	     */
	    this.requestAccess = function (directReport) {
	        navigationService.go({
	            outcome: 'requestAccess#/accessRequest/manageAccess/add?identityName=' + directReport.name
	        });
	    };
	    /**
	     ...
	     * @param {DirectReport} directReport The direct report.
	     */
	    this.managePasswords = function (directReport) {
	        navigationService.go({
	            outcome: 'managePasswords#/identities/' + directReport.id + '/passwords'
	        });
	    };
	    /**
	     ...
	     * @param {DirectReport} directReport The direct report.
	     */
	    this.manageAccounts = function (directReport) {
	        navigationService.go({
	            outcome: 'manageAccounts#/identities/' + directReport.id + '/accounts'
	        });
	    };
	    ////////////////////////////////////////////////////////////////////////
	    //
	...
	SailPoint.extend(MostEntitlementsUserWidgetDirectiveCtrl, AbstractListCtrl_1["default"]);
